...
- O formato JSON aceito pelo importador de templates do Elementor requer a estrutura de página/container com chaves limpas, IDs hexadecimais de 7 caracteres e propriedades de flexbox corretas (lex_direction, lex_gap, etc.).
